...
require (
	...
	kubevirt.io/kubevirt v1.7.0 // Transitive deps will handle k8s.io and others
...
// From KubeVirt's go.mod to pin k8s.io deps to v0.33.5 (fixes latest v0.33.3 pull and missing packages)
...
replace k8s.io/legacy-cloud-providers => k8s.io/legacy-cloud-providers v0.33.5

replace k8s.io/metrics => k8s.io/metrics v0.33.5

replace k8s.io/node-api => k8s.io/node-api v0.33.5
