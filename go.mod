...
require (
	...
	kubevirt.io/kubevirt v1.8.0 // Transitive deps will handle k8s.io and others
...
// From KubeVirt's go.mod to pin k8s.io deps to v0.34.2 (fixes latest v0.33.3 pull and missing packages)
...
replace k8s.io/legacy-cloud-providers => k8s.io/legacy-cloud-providers v0.34.2

replace k8s.io/metrics => k8s.io/metrics v0.34.2

replace k8s.io/node-api => k8s.io/node-api v0.34.2
...
// controller-lifecycle-operator-sdk/api v0.2.4 has no go-import metadata at kubevirt.io
replace kubevirt.io/controller-lifecycle-operator-sdk/api => github.com/kubevirt/controller-lifecycle-operator-sdk/api v0.2.4
